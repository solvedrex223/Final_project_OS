from Packages.General_funcctions import write_str_bin, int_to_string, bytes_to_string, string_to_int
from Packages.Inode import Inode
import Packages.Block as B
import  math
from Packages.dir_functions import add_file_to_dir
...
def mk_file(user, file_content, ref, parent_inode):
    ...
    while block < no_blocks:
        if block< 8:
            ...
            file = open(
                "/home/zikin/Documents/Final_project_OS/hard_drive/" + str(inodo.table_of_contents[block]) + ".block","r+b")
            ...
            offset = 0
            file_1 = open(
                "/home/zikin/Documents/Final_project_OS/hard_drive/" + str(inodo.table_of_contents[8]) + ".block",
                "r+b")
            while offset < 1024 and block < no_blocks:
                offset +=4
                no_block = LBL.free_block()
                write_str_bin(file_1, int_to_string(no_block, 4))
                file_2 = open("/home/zikin/Documents/Final_project_OS/hard_drive/" + str(no_block) + ".block","r+b")
                if (block + 1) * 1024 < len(file_content):
            ...
            offset_1 = 0
            file_1 = open(
                "/home/zikin/Documents/Final_project_OS/hard_drive/" + str(inodo.table_of_contents[9]) + ".block",
                "r+b")
            while offset_1 < 1024 and block < no_blocks:
                ...
                while offset_2 < 1024 and block < no_blocks:
                    ...
                    file_3 = open("/home/zikin/Documents/Final_project_OS/hard_drive/" + str(no_block) + ".block", "r+b")
                    if (block + 1) * 1024 < len(file_content):
            ...
            offset_1 = 0
            file_1 = open(
                "/home/zikin/Documents/Final_project_OS/hard_drive/" + str(inodo.table_of_contents[10]) + ".block",
                "r+b")
            while offset_1 < 1024 and block < no_blocks:
                offset_1 += 4
                no_block = LBL.free_block()
                ...
                while offset_2 < 1024 and block < no_blocks:
                    ...
                    while offset_3 < 1024  and block < no_blocks:
                        ...
                        file_4 = open("/home/zikin/Documents/Final_project_OS/hard_drive/" + str(no_block) + ".block",
                                      "r+b")
                        if (block + 1) * 1024 < len(file_content):
...
def cat(inode_no):
    ...
    for no_block in inode.find_content_blocks():
        file = open("/home/zikin/Documents/Final_project_OS/hard_drive/" + str(no_block) + ".block",
                                      "r+b")
