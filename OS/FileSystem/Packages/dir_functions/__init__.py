from Packages.General_funcctions import bytes_to_string, string_to_int, write_str_bin, int_to_string
...
def find_block(no_block, array):
    if no_block < 8:
        ...
        file = open("/home/zikin/Documents/Final_project_OS/hard_drive/"+array[8]+".block", "rb")
        ...
        file = open("/home/zikin/Documents/Final_project_OS/hard_drive/" + array[9] + ".block", "rb")
        file.seek(offset_1 * 4)
        data_block = string_to_int(bytes_to_string(file.read(4)))
        file.close()
        file = open("/home/zikin/Documents/Final_project_OS/hard_drive/" +data_block + ".block", "rb")
...
def ls(cwd):
    ...
    for block in cwd.find_content_blocks():
        file = open("/home/zikin/Documents/Final_project_OS/hard_drive/" + str(block) + ".block", "rb")
        offset = 0
        while offset < 1024:
...
def rm_from_dir(dir_name, cwd):
    ...
    file = open("/home/zikin/Documents/Final_project_OS/hard_drive/" + str(block) + ".block", "r+b")
