...
from Packages.General_funcctions import int_to_string, string_to_int, bytes_to_string
...
def set_hard_drive(dir_path = "/home/zikin/Documents/Final_project_OS/hard_drive"):
    ...
    for i in range(1, 1000001):
        print(i)
        file = open("/home/zikin/Documents/Final_project_OS/hard_drive/"+str(i)+".block","wb")
